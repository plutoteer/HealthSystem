...
<template>
  <div class="page-container">
    ...
    <el-dialog
      ...
      @close="clearForm"
    >
      <el-form ref="sportFormRef" :model="sportForm" :rules="rules">
        <el-form-item label="运动类型" prop="sportType" :label-width="formLabelWidth">
          <el-input v-model="sportForm.sportType" autocomplete="off" />
        </el-form-item>
        ...
        >
          <el-input v-model="sportForm.suitableFrequency" autocomplete="off" />
        </el-form-item>

        <el-form-item label="运动时间" prop="suitableTime" :label-width="formLabelWidth">
          <el-input v-model="sportForm.suitableTime" autocomplete="off" />
        </el-form-item>
        ...
        <el-form-item
          ...
          :label-width="formLabelWidth"
        >
          <el-input v-model="sportForm.recommendedSpeed" autocomplete="off" />
        </el-form-item>
        ...
        <el-form-item
          ...
          :label-width="formLabelWidth"
        >
          <el-input v-model="sportForm.suitableHeartRate" autocomplete="off" />
        </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        suitableFrequency: [
          { required: true, message: '请输入运动频率', trigger: 'blur' }
        ],
        suitableTime: [
        ...
        suitableHeartRate: [
          { required: true, message: '请输入运动心率', trigger: 'blur' }
        ]
      }
    }
  },
